...
//     const sptr<IRemoteObject> &__attribute__((unused)) preToken, const AbilityInfo &__attribute__((unused))
//     abilityInfo, const ApplicationInfo &__attribute__((unused)) appInfo)
// {
