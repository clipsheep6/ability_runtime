...
public:
    ...
    explicit UIExtensionAbilityConnectManager(int32_t userId);
     ...
     */
    int32_t GenerateUIExtensionAbilityId(int32_t uiExtensionAbilityId);
     ...
     */
    void AddUIExtensionAbilityRecord(int32_t uiExtensionAbilityId,
     ...
     * @param uiExtensionAbilityId uiextensionability id.
     */
    void RemoveUIExtensionAbilityRecord(int32_t uiExtensionAbilityId);
     ...
     */
    bool CheckUIExtensionAbilityLoaded(int32_t uiExtensionAbilityId, std::string hostBundleName);

    /**
     * @brief Check if specified uiextensionability can be terminated.
     *
     * @param uiExtensionAbilityId
     * @return true Can be terminated.
     * @return false Can't be terminated.
     */
    bool CheckUIExtensionAbilityTerminable(int32_t uiExtensionAbilityId);
