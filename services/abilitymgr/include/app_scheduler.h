...
public:
    ...
    virtual void NotifyStartResidentProcess(const std::vector<AppExecFwk::BundleInfo> &bundleInfos) {}
};
...
protected:
     ...
     */
    virtual void NotifyStartResidentProcess(const std::vector<AppExecFwk::BundleInfo> &bundleInfos) override;
