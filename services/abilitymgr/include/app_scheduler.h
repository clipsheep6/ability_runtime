...
public:
    ...
    virtual void OnAppRemoteDied(std::vector<sptr<IRemoteObject>> &abilityTokens) {}
};
...
protected:
    ...
    virtual void OnAppRemoteDied(std::vector<sptr<IRemoteObject>> &abilityTokens) override;
