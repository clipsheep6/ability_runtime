...
public:
    ...
    void HandleFocused(const sptr<OHOS::Rosen::FocusChangeInfo> &focusChangeInfo) const;

    void HandleUnfocused(const sptr<OHOS::Rosen::FocusChangeInfo> &focusChangeInfo) const;
#endif
