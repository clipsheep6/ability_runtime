...
#include "lock_screen_event_subscribe.h"
...
private:
    ...
    int ChangedPowerStorageAbilityToActive(std::shared_ptr<PowerStorage> &powerStorage, bool isPowerStateLockScreen = false);
