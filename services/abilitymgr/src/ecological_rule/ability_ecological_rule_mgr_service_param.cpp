...
std::string AbilityCallerInfo::ToString() const
{
    std::string str = "CallerInfo{packageName:" + packageName + ",uid:" + std::to_string(uid) +
        ...
        std::to_string(targetLinkType) + ",callerAbilityType:" + std::to_string(static_cast<int32_t>(callerAbilityType)) +
        ",callerExtensionAbilityType:" + std::to_string(static_cast<int32_t>(callerExtensionAbilityType)) + ",embedded:" +
