...
int AbilityManagerProxy::GetDialogSessionInfo(const std::string &dialogSessionId,
...
int AbilityManagerProxy::SendDialogResult(const Want &want, const std::string &dialogSessionId,
    bool isAllow)
{
    MessageParcel data;
    MessageParcel reply;
