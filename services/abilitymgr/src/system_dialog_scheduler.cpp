...
namespace OHOS {
namespace AAFwk {
const int32_t UI_SELECTOR_DIALOG_WIDTH = 420 * 2;
const int32_t UI_SELECTOR_DIALOG_HEIGHT = 450 * 2;
const int32_t UI_SELECTOR_DIALOG_HEIGHT_NARROW = 350 * 2;
const int32_t UI_SELECTOR_DIALOG_WIDTH_NARROW = 328 * 2;
const int32_t UI_SELECTOR_DIALOG_PHONE_H1 = 340 * 2;
const int32_t UI_SELECTOR_DIALOG_PHONE_H2 = 440 * 2;
const int32_t UI_SELECTOR_DIALOG_PHONE_H3 = 450 * 2;
