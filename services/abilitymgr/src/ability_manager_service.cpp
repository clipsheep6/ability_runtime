    ...
    sptr<IRemoteObject> asCallerSoureToken, int32_t userId, int requestCode, bool isSendDialogResult, bool isImplicit)
{
    ...
    int32_t ret = StartAbilityWrap(newWant, callerToken, requestCode, userId, true, isSendDialogResult, 0, false,
        isImplicit);
    if (ret != ERR_OK) {
        eventInfo.errCode = ret;
        SendAbilityEvent(EventName::START_ABILITY_ERROR, HiSysEventType::FAULT, eventInfo);
...
int AbilityManagerService::StartAbilityWrap(const Want &want, const sptr<IRemoteObject> &callerToken,
    ...
    bool isForegroundToRestartApp, bool isImplicitStart)
{
    ...
    return StartAbilityInner(want, callerToken, requestCode, userId, isStartAsCaller, isSendDialogResult, specifyToken,
        isForegroundToRestartApp, isImplicitStart);
}
    ...
    int32_t userId, int requestCode, bool isImplicit)
{
    ...
    return StartAbilityForOptionWrap(newWant, startOptions, callerToken, userId, requestCode, true, isImplicit);
}
