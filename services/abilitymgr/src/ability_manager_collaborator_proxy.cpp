    ...
    const AppExecFwk::AbilityInfo &abilityInfo, int32_t userId, Want &want, uint64_t accessTokenIDEx)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_START_ABILITY, data, reply, option);
    if (ret != NO_ERROR) {
...
int32_t AbilityManagerCollaboratorProxy::NotifyMissionCreated(int32_t missionId, const Want &want)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_MISSION_CREATED, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyMissionCreated(const sptr<SessionInfo> &sessionInfo)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_MISSION_CREATED_BY_SCB, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
    ...
    const AppExecFwk::AbilityInfo &abilityInfo, int32_t missionId, const Want &want)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_LOAD_ABILITY, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
    ...
    const AppExecFwk::AbilityInfo &abilityInfo, const sptr<SessionInfo> &sessionInfo)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_LOAD_ABILITY_BY_SCB, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyMoveMissionToBackground(int32_t missionId)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_MOVE_MISSION_TO_BACKGROUND, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyMoveMissionToForeground(int32_t missionId)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_MOVE_MISSION_TO_FOREGROUND, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyTerminateMission(int32_t missionId)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_TERMINATE_MISSION, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyClearMission(int32_t missionId)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_CLEAR_MISSION, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
int32_t AbilityManagerCollaboratorProxy::NotifyRemoveShellProcess(int32_t pid, int32_t type, const std::string &reason)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::NOTIFY_REMOVE_SHELL_PROCESS, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return ret;
    }
...
void AbilityManagerCollaboratorProxy::UpdateMissionInfo(InnerMissionInfoDto &info)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::UPDATE_MISSION_INFO, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return;
    }
...
void AbilityManagerCollaboratorProxy::UpdateMissionInfo(sptr<SessionInfo> &sessionInfo)
{
    ...
    int32_t ret = SendRequest(IAbilityManagerCollaborator::UPDATE_MISSION_INFO_BY_SCB, data, reply, option);
    if (ret != NO_ERROR) {
        HILOG_ERROR("Send request error: %{public}d", ret);
        return;
    }
...
int32_t AbilityManagerCollaboratorProxy::SendRequest(uint32_t code, MessageParcel &data,
