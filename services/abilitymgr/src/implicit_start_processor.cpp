    ...
    AbilityRequest &request, std::vector<DialogAppInfo> &dialogAppInfos, std::string &deviceType, bool isMoreHapList)
{
    ...
    IN_PROCESS_CALL_WITHOUT_RET(
        client->ImplicitQueryInfos(request.want, abilityInfoFlag, userId, withDefault, abilityInfos, extensionInfos));
    ...
    if (deviceType != STR_PHONE && deviceType != STR_DEFAULT) {
        IN_PROCESS_CALL_WITHOUT_RET(client->ImplicitQueryInfos(
