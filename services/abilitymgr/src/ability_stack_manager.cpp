...
int AbilityStackManager::MoveMissionToEndLocked(int missionId)
{
    ...
    if (IsSplitScreenStack(requestStack->GetMissionStackId()) || IsSplitScreenStack(currentStack->GetMissionStackId()))
    {
        ...
        if (mission->IsEmpty()) {
            ...
            if (IsSplitScreenStack(stack->GetMissionStackId())) {
                ...
                if (friendMission && friendStack) {
                    UpdateMissionOption(friendMission,
                        defaultMissionStack_,
