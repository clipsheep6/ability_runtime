...
namespace OHOS {
namespace AAFwk {
class MissionDumpModuleTest : public testing::Test {
public:
...
void MissionDumpModuleTest::SetUpTestCase()
{}

void MissionDumpModuleTest::TearDownTestCase()
{}

void MissionDumpModuleTest::SetUp()
{}

void MissionDumpModuleTest::TearDown()
{}
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_Mission_List_001, TestSize.Level1)
{
    int userId = 100;
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_Mission_List_002, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_Mission_List_003, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_Mission_List_004, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_MissionList_ByRecordId_001, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_MissionList_ByRecordId_002, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
 ...
 * CaseDescription:
 */
HWTEST_F(MissionDumpModuleTest, Dump_MissionList_ByRecordId_003, TestSize.Level1)
{
    int userId = 100;
    auto missionListManager = std::make_shared<MissionListManager>(userId);
    EXPECT_TRUE(missionListManager);
