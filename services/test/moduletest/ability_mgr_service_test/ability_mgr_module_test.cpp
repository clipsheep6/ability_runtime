...
static void OnStartAms()
{
    if(AbilityMgrModuleTest::abilityMgrServ_){
        ...
        AbilityMgrModuleTest::abilityMgrServ_->eventLoop_ = AppExecFwk::EventRunner::Create(AbilityConfig::NAME_ABILITY_MGR_SERVICE);
        EXPECT_TRUE(AbilityMgrModuleTest::abilityMgrServ_->eventLoop_);

        AbilityMgrModuleTest::abilityMgrServ_->handler_ = std::make_shared<AbilityEventHandler>(AbilityMgrModuleTest::abilityMgrServ_->eventLoop_, 
        ...
        AbilityMgrModuleTest::abilityMgrServ_->connectManager_->SetEventHandler(AbilityMgrModuleTest::abilityMgrServ_->handler_);
