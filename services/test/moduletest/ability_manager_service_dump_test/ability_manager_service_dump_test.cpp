 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysFuncInit_0100, TestSize.Level0)
{
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysInner_0100, TestSize.Level0)
{
    std::string args = "-a";
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysMissionListInner_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysAbilityInner_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysStateInner_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysPendingInner_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DumpSysProcess_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_DataDumpSysStateInner_0100, TestSize.Level0)
{
    std::string args = "-a";
    std::vector<std::string> info;
    bool isClient = false;
 ...
 * @tc.require: SR000GH1GO
 */
HWTEST_F(AbilityManagerServiceDumpTest, AbilityManagerService_OnAppStateChanged_0100, TestSize.Level0)
{
