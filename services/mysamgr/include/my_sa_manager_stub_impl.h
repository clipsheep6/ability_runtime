...
#ifndef OHOS_AAFWK_MY_SA_MANAGER_STUB_IMPL_H
#define OHOS_AAFWK_MY_SA_MANAGER_STUB_IMPL_H
...
class MySaManagerStubImpl : public MySaManagerStub,
                                     public std::enable_shared_from_this<MySaManagerStubImpl> {
public:
    MySaManagerStubImpl() = default;
    virtual ~MySaManagerStubImpl() = default;
...
#endif  // OHOS_AAFWK_MY_SA_MANAGER_STUB_IMPL_H
