...
{
    APP_LOGI("ams_app_mgr_client_test_014 start");
    sptr<IRemoteObject> token;
    EXPECT_EQ(AppMgrResultCode::RESULT_OK, client_->ConnectAppMgrService());
    ...
    APP_LOGI("ams_app_mgr_client_test_014 end");
}
...
{
    APP_LOGI("ams_app_mgr_client_test_015 start");
    sptr<IRemoteObject> token;
    EXPECT_EQ(AppMgrResultCode::RESULT_OK, client_->ConnectAppMgrService());
    ...
    APP_LOGI("ams_app_mgr_client_test_015 end");
}
