...
#ifndef OHOS_ABILITY_RUNTIME_APP_NO_RESPONSE_H
#define OHOS_ABILITY_RUNTIME_APP_NO_RESPONSE_H
...
#endif // APP_NO_RESPONSE
#endif // OHOS_ABILITY_RUNTIME_APP_NO_RESPONSE_H