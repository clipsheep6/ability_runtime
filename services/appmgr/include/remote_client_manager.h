...
public:
     ...
     */
    std::shared_ptr<AppExecFwk::BundleMgrClient> GetBundleManagerClient();
     ...
     */
    void SetBundleManagerClient(std::shared_ptr<AppExecFwk::BundleMgrClient> bundleMgrClient);

    std::shared_ptr<AppSpawnClient> GetNWebSpawnClient();

private:
    std::shared_ptr<AppSpawnClient> appSpawnClient_;
    std::shared_ptr<AppExecFwk::BundleMgrClient> bundleManagerClient_;
