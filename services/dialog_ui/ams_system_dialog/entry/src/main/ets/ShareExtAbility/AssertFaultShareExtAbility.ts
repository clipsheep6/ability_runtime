...
export default class UiExtAbility extends UIExtensionAbility {
  ...
  onSessionCreate(want, session: UIExtensionContentSession): void {
    ...
    console.info(TAG, `onSessionCreate, sessionId: ${want.parameters[wantConstant.Params.ASSERT_FAULT_SESSION_ID]}`);
