...
class EventReport {
public:
    static void AbilityEntranceErrorEvent(int32_t &userId, int32_t &errorCode, int32_t pid,  int32_t uid,
        const AAFwk::Want &want, const std::string &eventName, HiSysEventType type);
    static void AbilityEntranceEvent(int32_t &userId, int32_t errorCode, int32_t &pid, int32_t &uid,
