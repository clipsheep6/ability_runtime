...
#ifndef OHOS_AAFWK_INTERFACES_INNERKITS_I_DEVICE_SELECTION_NOTIFIER_H
#define OHOS_AAFWK_INTERFACES_INNERKITS_I_DEVICE_SELECTION_NOTIFIER_H
...
#endif  // OHOS_AAFWK_INTERFACES_INNERKITS_I_DEVICE_SELECTION_NOTIFIER_H
