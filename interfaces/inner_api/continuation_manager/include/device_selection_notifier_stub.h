...
#ifndef OHOS_AAFWK_INTERFACES_INNERKITS_DEVICE_SELECTION_NOTIFIER_STUB_H
#define OHOS_AAFWK_INTERFACES_INNERKITS_DEVICE_SELECTION_NOTIFIER_STUB_H
...
#endif  // OHOS_AAFWK_INTERFACES_INNERKITS_DEVICE_SELECTION_NOTIFIER_STUB_H
