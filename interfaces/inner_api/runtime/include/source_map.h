...
public:
    ...
    static std::string GetSourceCodeInfo(const EcmaVM* vm, const panda::Local<panda::JSValueRef> function,
...
private:
    ...
    static MappingInfo Find(int32_t row, int32_t col, const SourceMapData& targetMap);
    ...
    static std::string GetSourceInfo(const std::string& line, const std::string& column, const SourceMapData& targetMap);
