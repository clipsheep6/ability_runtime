...
#ifndef OHOS_ABILITY_RUNTIME_CJ_ABILITY_RUNTIME_H
#define OHOS_ABILITY_RUNTIME_CJ_ABILITY_RUNTIME_H
...
class CJAbilityRuntime : public Runtime {
public:
    static std::unique_ptr<CJAbilityRuntime> Create(const Options& options);
    static void SetAppLibPath(const AppLibPathMap& appLibPaths);
    ~CJAbilityRuntime() override = default;
...
#endif // OHOS_ABILITY_RUNTIME_CJ_ABILITY_RUNTIME_H
