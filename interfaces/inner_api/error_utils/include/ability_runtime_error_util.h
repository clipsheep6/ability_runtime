...
enum {
    ...
    ERR_ABILITY_RUNTIME_SET_SUPPORTED_PROCESS_CACHE_AGAIN = 16000068,
...
public:
    ...
    /**
     * @brief Throw an runtime exception for js with too few param.
     * @param engine js runtime engine.
     * @return true if success.
     */
    static bool ThrowTooFewParametersError(napi_env env);
