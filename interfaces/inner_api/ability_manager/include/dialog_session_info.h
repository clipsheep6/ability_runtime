...
public:
    ...
    int32_t bundleIconId;
    int32_t bundleLabelId;
    int32_t abilityIconId;
    int32_t abilityLabelId;
...
struct DialogSessionInfo : public Parcelable {
    ...
    std::vector<DialogAbilityInfo> targetAbilityInfos; // get info form erms or bms
