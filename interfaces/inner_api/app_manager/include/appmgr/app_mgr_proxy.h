...
public:
    ...
    int32_t NotifyLoadPatch(const std::string &bundleName, const sptr<IQuickFixCallback> &callback, const int &patchVersion) override;
    ...
    int32_t NotifyUnLoadPatch(const std::string &bundleName, const sptr<IQuickFixCallback> &callback) override;
