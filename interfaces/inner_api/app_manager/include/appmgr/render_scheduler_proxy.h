...
#ifndef OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_PROXY_H
#define OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_PROXY_H
...
public:
    ...
    virtual void NotifyBrowserFd(int32_t ipcFd, int32_t sharedFd,
                                 int32_t crashFd, const sptr<IRemoteObject> &browser) override;
...
#endif  // OHOS_ABILITY_RUNTIME_RENDER_SCHEDULER_PROXY_H
