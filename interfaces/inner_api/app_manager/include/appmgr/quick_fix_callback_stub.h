...
private:
    ...
    int32_t HandleOnUnloadHotloadDoneInner(MessageParcel &data, MessageParcel &reply);
    int32_t HandleOnHotloadFormDoneInner(MessageParcel &data, MessageParcel &reply);
