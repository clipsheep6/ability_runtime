...
private:
    bool GetDisplayConfig(Rosen::DisplayId displayId, std::string &densityStr, std::string &directionStr);
    void UpdateDisplayResConfig(std::shared_ptr<ResourceManager> resourceManager, std::string &density,
