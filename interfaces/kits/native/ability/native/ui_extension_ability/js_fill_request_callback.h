...
public:
    JsFillRequestCallback(sptr<AAFwk::SessionInfo> sessionInfo, sptr<Rosen::Window> uiWindow);
...
private:    
    ...
    void SendResultCodeAndViewData(napi_env env, NapiCallbackInfo &info, ResultCode resultCode, std::string jsString);
