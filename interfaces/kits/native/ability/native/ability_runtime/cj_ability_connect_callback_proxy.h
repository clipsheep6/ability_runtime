...
#ifndef OHOS_ABILITY_RUNTIME_CJ_ABILITY_CONNECT_CALLBACK_PROXY_H
#define OHOS_ABILITY_RUNTIME_CJ_ABILITY_CONNECT_CALLBACK_PROXY_H
...
#endif // OHOS_ABILITY_RUNTIME_CJ_ABILITY_CONNECT_CALLBACK_PROXY_H
