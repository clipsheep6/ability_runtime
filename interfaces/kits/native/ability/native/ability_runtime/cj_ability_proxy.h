...
#ifndef OHOS_ABILITY_RUNTIME_CJ_ABILITY_PROXY_H
#define OHOS_ABILITY_RUNTIME_CJ_ABILITY_PROXY_H
...
public:
    static std::shared_ptr<CJAbilityProxy> LoadModule(const std::string& name);

    explicit CJAbilityProxy(int64_t id) : id_(id) {}
    ~CJAbilityProxy();
