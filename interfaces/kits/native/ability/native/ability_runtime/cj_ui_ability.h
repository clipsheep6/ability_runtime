...
class CJAbilityRuntime;
class CJAbilityProxy;
...
public:
    ...
    explicit CJUIAbility(CJAbilityRuntime &cjAbilityRuntime);
    ...
    std::shared_ptr<CJAbilityProxy> GetCJAbility();
...
public:
    ...
    /**
     * @brief Get CJAbilityRuntime
     * @return Returns the current CJAbilityRuntime
     */
    const CJAbilityRuntime &GetCJAbilityRuntime();
...
private:
    ...
    CJAbilityRuntime &cjAbilityRuntime_;
    std::shared_ptr<CJAbilityProxy> cjAbilityObj_;
