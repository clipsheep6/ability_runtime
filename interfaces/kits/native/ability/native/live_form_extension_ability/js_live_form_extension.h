...
#ifndef OHOS_ABILITY_RUNTIME_JS_LIVE_FORM_EXTENSION_H
#define OHOS_ABILITY_RUNTIME_JS_LIVE_FORM_EXTENSION_H
...
class LiveFormExtension;
class JsRuntime;
class JsUIExtensionBase;
/**
 * @brief Basic share extension components.
 */
class JsLiveFormExtension : public LiveFormExtension, public std::enable_shared_from_this<JsLiveFormExtension> {
public:
    explicit JsLiveFormExtension(const std::unique_ptr<Runtime> &runtime);
    virtual ~JsLiveFormExtension() override;
