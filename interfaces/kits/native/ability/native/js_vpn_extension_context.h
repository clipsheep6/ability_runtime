...
class JSVpnExtensionConnection : public AbilityConnectCallback {
public:
    explicit JSVpnExtensionConnection(napi_env env);
    ~JSVpnExtensionConnection();
...
static std::map<ConnectionKey, sptr<JSVpnExtensionConnection>, key_compare> connects_;
