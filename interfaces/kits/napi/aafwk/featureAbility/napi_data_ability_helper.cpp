...
napi_value DataAbilityHelperConstructor(napi_env env, napi_callback_info info)
{
    ...
    HILOG_INFO("g_dataAbilityHelperList.size = %{public}d", g_dataAbilityHelperList.size());
    ...
    napi_wrap(
        ...
        [](napi_env env, void *data, void *hint) {
            ...
            HILOG_INFO("DataAbilityHelper finalize_cb registerInstances_.size = %{public}d", registerInstances_.size());
            ...
            HILOG_INFO("DataAbilityHelper finalize_cb registerInstances_.size = %{public}d", registerInstances_.size());
            HILOG_INFO("DataAbilityHelper finalize_cb g_dataAbilityHelperList.size = %{public}d",
...
napi_value WrapGetFileTypesCB(napi_env env, const DAHelperGetFileTypesCB &getfiletypesCB)
{
    ...
    HILOG_INFO("NAPI_GetFileTypes, result.size:%{public}d", getfiletypesCB.result.size());
    for (size_t i = 0; i < getfiletypesCB.result.size(); i++) {
        HILOG_INFO("NAPI_GetFileTypes, result[%{public}d]:%{public}s", i, getfiletypesCB.result.at(i).c_str());
    }
