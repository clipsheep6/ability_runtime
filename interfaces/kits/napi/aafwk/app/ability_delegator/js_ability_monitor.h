...
public:
    JSAbilityMonitor(const std::string &abilityName);
    ...
    void SetJsAbilityMonitorEnv(NativeEngine* engine) { engine_ = engine; } 
    std::unique_ptr<NativeReference> &GetJsAbilityMonitor() { return jsAbilityMonitor_; }
