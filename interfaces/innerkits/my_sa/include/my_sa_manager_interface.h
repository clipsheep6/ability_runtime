...
#ifndef OHOS_AAFWK_My_SA_MANAGER_INTERFACE_H
#define OHOS_AAFWK_My_SA_MANAGER_INTERFACE_H
...
namespace OHOS {
namespace AAFwk {
class IMySaManager : public IRemoteBroker {
public:
    DECLARE_INTERFACE_DESCRIPTOR(u"ohos.aafwk.MySaManager");
...
#endif  // OHOS_AAFWK_My_SA_MANAGER_INTERFACE_H