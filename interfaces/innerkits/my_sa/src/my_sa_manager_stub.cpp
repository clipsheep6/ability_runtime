...
namespace OHOS {
namespace AAFwk {
int MySaManagerStub::OnRemoteRequest(
    uint32_t code, MessageParcel &data, MessageParcel &reply, MessageOption &option)
{
    if (data.ReadInterfaceToken() != IMySaManager::GetDescriptor()) {
        HILOG_ERROR("InterfaceToken not equal IMySaManager's descriptor.");
