...
public:
    explict AppMgrDeathRecipient(const std::shared_ptr<AppMgrRemoteHolder>& holder)
    {
        owner_ = holder;
    }
...
public:
    ...
    AppMgrResultCode ConnectAppMgrService()
    {
        ...
        deathRecipient_ = sptr<IRemoteObject::DeathRecipient>(new AppMgrDeathRecipient(std::shared_from_this()));
