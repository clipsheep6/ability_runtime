...
FormShareConnection::FormShareConnection(const int64_t formId, const std::string &bundleName,
    const std::string &abilityName, const std::string &deviceId, const int64_t formShareRequestCode)
