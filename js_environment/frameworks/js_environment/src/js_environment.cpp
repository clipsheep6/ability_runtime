...
void JsEnvironment::InitWorkerModule(NativeEngine& engine, const std::string& codePath, bool isDebugVersion, bool isBundle)
{
    if (impl_ != nullptr) {
        impl_->InitWorkerModule(engine, codePath, isDebugVersion, isBundle);
    }
}
