 ...
 */
#include "napi_data_ability_helper_inner.h"
...
static napi_value CallPacMapValue(napi_env env, std::shared_ptr<AppExecFwk::PacMap> result)
{
...
static void CallAsyncCompleteCB(napi_env env, napi_status status, void *data)
{
...
static void CallPromiseCompleteCB(napi_env env, napi_status status, void *data)
{
...
static void SetPacMapObject(AppExecFwk::PacMap &pacMap, const napi_env &env, std::string keyStr, napi_value value)
{
    napi_valuetype valueType = napi_undefined;
