...
#else
extern "C" __attribute__((constructor))
void NAPI_application_DriverExtensionAbility_AutoRegister()
{
    auto moduleManager = NativeModuleManager::GetInstance();
    NativeModule newModuleInfo = {
        .name = "application.DriverExtensionAbility",
        .fileName = "application/libdriverextensionability_napi.so/driver_extension_ability.js",
    };
...
extern "C" __attribute__((visibility("default")))
void NAPI_application_DriverExtensionAbility_GetJSCode(const char **buf, int *bufLen)
{
    if (buf != nullptr) {
        *buf = _binary_driver_extension_ability_js_start;
    }
...
extern "C" __attribute__((visibility("default")))
void NAPI_application_DriverExtensionAbility_GetABCCode(const char **buf, int *buflen)
{
    if (buf != nullptr) {
        *buf = _binary_driver_extension_ability_abc_start;
    }
