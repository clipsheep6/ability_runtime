...
static napi_module _module = {
    .nm_version = 0,
    .nm_filename = "app/ability/libliveformextensionability_napi.so/live_form_extension_ability.js",
    .nm_modname = "app.ability.LiveFormExtensionAbility",
};
extern "C" __attribute__((constructor)) void NAPI_app_ability_LiveFormExtensionAbility_AutoRegister()
{
    napi_module_register(&_module);
}
 
extern "C" __attribute__((visibility("default"))) void NAPI_app_ability_LiveFormExtensionAbility_GetJSCode(
...
extern "C" __attribute__((visibility("default"))) void NAPI_app_ability_LiveFormExtensionAbility_GetABCCode(
    const char **buf, int *buflen)
{
    if (buf != nullptr) {
