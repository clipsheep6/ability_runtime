...
public:
     ...
     * @param stagePath Indicates the abilityStage source path.
     */
    AbilityStageMonitor(const std::string &moduleName, const std::string &stagePath) 
        : IAbilityStageMonitor(moduleName, stagePath) {}
