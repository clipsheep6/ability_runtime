...
public:
     ...
     * @return exec result.
     */
    static napi_value AddAbilityMonitorSync(napi_env env, napi_callback_info info);
     ...
     * @return exec result.
     */
    static napi_value AddAbilityStageMonitorSync(napi_env env, napi_callback_info info);
     ...
     * @return exec result.
     */
    static napi_value RemoveAbilityMonitorSync(napi_env env, napi_callback_info info);
     ...
     * @return exec result.
     */
    static napi_value RemoveAbilityStageMonitorSync(napi_env env, napi_callback_info info);
     ...
     * @return exec result.
     */
    static napi_value ExecuteShellCommand(napi_env env, napi_callback_info info);
...
private:
    napi_value OnAddAbilityMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnAddAbilityMonitorSync(napi_env env, size_t argc, napi_value* argv);
    napi_value OnAddAbilityStageMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnAddAbilityStageMonitorSync(napi_env env, size_t argc, napi_value* argv);
    napi_value OnRemoveAbilityMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnRemoveAbilityMonitorSync(napi_env env, size_t argc, napi_value* argv);
    napi_value OnRemoveAbilityStageMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnRemoveAbilityStageMonitorSync(napi_env env, size_t argc, napi_value* argv);
    napi_value OnWaitAbilityMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnWaitAbilityStageMonitor(napi_env env, size_t argc, napi_value* argv);
    napi_value OnPrint(napi_env env, size_t argc, napi_value* argv);
    napi_value OnPrintSync(napi_env env, size_t argc, napi_value* argv);
    napi_value OnExecuteShellCommand(napi_env env, size_t argc, napi_value* argv);
    napi_value OnGetAppContext(napi_env env, size_t argc, napi_value* argv);
    napi_value OnGetAbilityState(napi_env env, size_t argc, napi_value* argv);
    napi_value OnGetCurrentTopAbility(napi_env env, size_t argc, napi_value* argv);
    napi_value OnStartAbility(napi_env env, size_t argc, napi_value* argv);
    napi_value OnDoAbilityForeground(napi_env env, size_t argc, napi_value* argv);
    napi_value OnDoAbilityBackground(napi_env env, size_t argc, napi_value* argv);
    napi_value OnFinishTest(napi_env env, size_t argc, napi_value* argv);
    napi_value OnSetMockList(napi_env env, size_t argc, napi_value* argv); 
...
private:
    ...
    napi_value ParseAbilityPara(napi_env env, napi_value value, sptr<OHOS::IRemoteObject> &remoteObject);
    ...
    napi_value ParseAbilityStageMonitorPara(napi_env env, size_t argc, napi_value* argv,
        std::shared_ptr<AbilityStageMonitor> &monitor, bool &isExisted, bool isSync);
    napi_value ParseWaitAbilityMonitorPara(napi_env env, size_t argc, napi_value* argv,
        std::shared_ptr<AbilityMonitor> &monitor, TimeoutCallback &opt, int64_t &timeout);
    napi_value ParseWaitAbilityStageMonitorPara(napi_env env, size_t argc, napi_value* argv,
    ...
    napi_value ParsePrintPara(napi_env env, size_t argc, napi_value* argv, std::string &msg);
    napi_value ParseExecuteShellCommandPara(
    ...
    napi_value ParseFinishTestPara(napi_env env, size_t argc, napi_value* argv, std::string &msg, int64_t &code);
    bool ParseMockListPara(
        napi_env env, size_t argc, napi_value* argv, std::map<std::string, std::string> &mockList);
    bool ParseArrayStringValue(napi_env env, napi_value param, std::vector<std::string> &value);
