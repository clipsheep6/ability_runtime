...
NativeValue *CreateJsAbilityDelegator(NativeEngine &engine)
{
    ...
    BindNativeFunction(engine, *object, "addAbilityStageMonitor", moduleName, JSAbilityDelegator::AddAbilityStageMonitor);
    BindNativeFunction(engine, *object, "removeAbilityMonitor", moduleName, JSAbilityDelegator::RemoveAbilityMonitor);
    BindNativeFunction(engine, *object, "removeAbilityStageMonitor", moduleName, JSAbilityDelegator::RemoveAbilityStageMonitor);
    BindNativeFunction(engine, *object, "waitAbilityMonitor", moduleName, JSAbilityDelegator::WaitAbilityMonitor);
    BindNativeFunction(engine, *object, "waitAbilityStageMonitor", moduleName, JSAbilityDelegator::WaitAbilityStageMonitor);
