...
napi_value CreateJsBaseContextFromSendable(napi_env env, void* wrapped)
{
    ...
    if (contextPtr == nullptr) {
        TAG_LOGE(AAFwkTag::CONTEXT, "failed to convert context");
        return nullptr;
    }
...
napi_value CreateJsAbilityStageContextFromSendable(napi_env env, void* wrapped)
{
    ...
    if (abilitystageContext == nullptr) {
        TAG_LOGE(AAFwkTag::CONTEXT, "failed to convert ability stage context");
        return nullptr;
    }
...
napi_value CreateJsUIAbilityContextFromSendable(napi_env env, void* wrapped)
{
    ...
    if (uiAbilityContext == nullptr) {
        TAG_LOGE(AAFwkTag::CONTEXT, "failed convert context to UIAbility context");
        return nullptr;
    }
...
public:
    ...
    static void Finalizer(napi_env env, void *data, void *hint)
    {
        TAG_LOGD(AAFwkTag::CONTEXT, "finalizer");
        if (data == nullptr) {
