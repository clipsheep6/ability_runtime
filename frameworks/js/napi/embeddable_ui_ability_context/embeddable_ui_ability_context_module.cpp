...
void NAPI_application_EmbeddableUIAbilityContext_GetJSCode(const char **buf, int *bufLen)
{
    if (buf != nullptr) {
...
extern "C" __attribute__((visibility("default")))
void NAPI_application_EmbeddableUIAbilityContext_GetABCCode(const char **buf, int *buflen)
{
    if (buf != nullptr) {
