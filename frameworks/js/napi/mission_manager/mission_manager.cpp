...
NativeValue* JsMissionManagerInit(NativeEngine* engine, NativeValue* exportObj)
{
    ...
    BindNativeFunction(*engine, *object, "registerMissionListener", moduleName, JsMissionManager::RegisterMissionListener);
    BindNativeFunction(*engine, *object, "unregisterMissionListener", moduleName, JsMissionManager::UnregisterMissionListener);
