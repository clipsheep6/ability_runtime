...
NativeValue* JsAbilityManagerInit(NativeEngine* engine, NativeValue* exportObj)
{
    ...
    BindNativeFunction(*engine, *object, "getAbilityRunningInfos", moduleName, JsAbilityManager::GetAbilityRunningInfos);
    BindNativeFunction(*engine, *object, "getExtensionRunningInfos", moduleName, JsAbilityManager::GetExtensionRunningInfos);
