    ...
    napi_valuetype jsValueProType)
{
    ...
    napi_valuetype jsValueType = napi_undefined;
    napi_value jsProValue = nullptr;
    NAPI_CALL_BASE(env, napi_get_named_property(env, jsWantParamProValue, std::string(TYPE_PROPERTY), &jsProValue), false);
    NAPI_CALL_BASE(env, napi_typeof(env, jsProValue, &jsValueType), false);
    ...
    jsProValue = nullptr;
    NAPI_CALL_BASE(env, napi_get_named_property(env, jsWantParamProValue, std::string(VALUE_PROPERTY), &jsProValue),
        false);
    NAPI_CALL_BASE(env, napi_typeof(env, jsProValue, &jsValueType), false);
...
=======
    NAPI_CALL_BASE(env, napi_get_named_property(env, jsWantParamProValue, std::string(VALUE_PROPERTY).c_str(), &jsProValue),
>>>>>>> const std::string->constexpr const char*
        false);
