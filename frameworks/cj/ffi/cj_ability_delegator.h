...
#ifndef OHOS_ABILITY_RUNTIME_OHOS_CJ_ABILITY_DELEGATOR_FFI_H
#define OHOS_ABILITY_RUNTIME_OHOS_CJ_ABILITY_DELEGATOR_FFI_H
...
extern "C" {
EXPORT int64_t FFIAbilityDelegatorRegistryGetAbilityDelegator();
EXPORT int32_t FFIAbilityDelegatorStartAbility(int64_t id, WantHandle want);
EXPORT int32_t FFIAbilityDelegatorExecuteShellCommand(int64_t id, const char* cmd, int64_t timeoutSec);
EXPORT int32_t FFIGetExitCode(int64_t id);
EXPORT const char* FFIGetStdResult(int64_t id);
EXPORT const char* FFIDump(int64_t id);
EXPORT int32_t FFIAbilityDelegatorApplicationContext(int64_t id);
};
#undef EXPORT
}
}
#endif // OHOS_ABILITY_RUNTIME_OHOS_CJ_ABILITY_DELEGATOR_FFI_H