...
#ifndef ABILITY_RUNTIME_CJ_APPLICATION_CONTEXT_H
#define ABILITY_RUNTIME_CJ_APPLICATION_CONTEXT_H
...
EXPORT int64_t FFIGetArea(int64_t id);
EXPORT CApplicationInfo* FFICJApplicationInfo(int64_t id);
};
#undef EXPORT
}
}
#endif // ABILITY_RUNTIME_CJ_APPLICATION_CONTEXT_H