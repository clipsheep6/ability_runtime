...
public:
    ...
    /**
     * @brief Migrates this ability to another device on the same distributed network. If there are multiple candidate
     * devices, a pop-up will be displayed for users to choose the desired one. The ability to migrate and its ability
     * slices must implement the IAbilityContinuation interface.
     *
     */
    virtual void ContinueAbility() final;
