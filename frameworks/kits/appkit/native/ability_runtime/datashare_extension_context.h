...
#ifndef DATASHARE_EXTENSION_CONTEXT_H
#define DATASHARE_EXTENSION_CONTEXT_H
 ...
 *
 */
class DataShareExtensionContext : public ExtensionContext {
public:
    DataShareExtensionContext() = default;
    virtual ~DataShareExtensionContext() = default;

    /**
     * @brief Starts a new ability.
     * An ability using the AbilityInfo.AbilityType.DATA template uses this method
    ...
    /**
     * @brief Connects the current ability to an ability using the AbilityInfo.AbilityType.DATA template.
     *
    ...
    using SelfType = DataShareExtensionContext;
...
#endif  // DATASHARE_EXTENSION_CONTEXT_H