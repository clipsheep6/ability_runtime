...
constexpr uint8_t CAP_MAX_SIZE = 64;
}
...
void MainThread::HandleLaunchApplication(const AppLaunchData &appLaunchData, const Configuration &config)
{
    ...
    if (isStageBased) {
        ...
        auto uncaughtTask = [weak, uid, processPid, bundleName, processName](NativeValue* v) {
            ...
            char messagecap[CAP_MAX_SIZE] = { 0 };
            ...
            char stackcap[CAP_MAX_SIZE] = { 0 };
            messageStr->GetCString(stackcap, stackbufferLen + 1, &stackstrLen);
            ...
            msgContent = "message:" + tempMessageStr + "tempStack:" + tempStackStr;
