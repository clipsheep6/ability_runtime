...
public:
    AbilityDelegator(MainThread *mainThread, std::unique_ptr<TestRunner> &&runner,
...
private:
    ...
    void MatchMonitor(const std::shared_ptr<Ability> &ability);
...
private:
    MainThread *mainThread_ {nullptr};
