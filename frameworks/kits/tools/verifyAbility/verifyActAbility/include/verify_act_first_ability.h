...
#ifndef _VERIFY_ACT_FIRST_ABILITY_
#define _VERIFY_ACT_FIRST_ABILITY_
...
public:
    AbilityContextStartAbilityTest(const EventFwk::CommonEventSubscribeInfo &sp) : EventFwk::CommonEventSubscriber(sp){};
    virtual void OnReceiveEvent(const EventFwk::CommonEventData &data);
};
class ConnectServiceAbilityTest : public EventFwk::CommonEventSubscriber {
public:
    ConnectServiceAbilityTest(
        const EventFwk::CommonEventSubscribeInfo &sp, std::shared_ptr<Context> abilityContext, sptr<AAFwk::IAbilityConnection> conne)
...
#endif  //_VERIFY_ACT_FIRST_ABILITY_