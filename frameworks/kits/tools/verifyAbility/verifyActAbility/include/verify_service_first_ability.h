...
#ifndef _VERIFY_SERVICE_FIRST_ABILITY_
#define _VERIFY_SERVICE_FIRST_ABILITY_
#include "ability_loader.h"
#include "common_event.h"
#include "common_event_manager.h"
namespace OHOS {
namespace AppExecFwk {
class VerifyServiceFirstAbility : public Ability {
public:
...
#endif  //_VERIFY_SERVICE_FIRST_ABILITY_