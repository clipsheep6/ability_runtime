...
{
    TAG_LOGI(AAFwkTag::UISERVC_EXT, "UIServiceStub::UIServiceStub");
    requestFuncMap_[SENDDATA] = &UIServiceStub::OnSendData;
}
...
{
    TAG_LOGI(AAFwkTag::UISERVC_EXT, "UIServiceStub::OnSendData");
