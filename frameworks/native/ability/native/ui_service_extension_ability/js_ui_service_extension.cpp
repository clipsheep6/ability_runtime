...
#ifdef SUPPORT_GRAPHICS
//	static sptr<Rosen::WindowOption> GetWindowOption(const AAFwk::Want &want)
//	{
...
std::shared_ptr<AppExecFwk::ADelegatorAbilityProperty> JsUIServiceExtension::CreateADelegatorAbilityProperty()
{
    ...
    property->token_ = GetContext()->GetToken();
...
{
    FreezeUtil::LifecycleFlow flow = { GetContext()->GetToken(), state };
