...
#ifdef IMAGE_PURGEABLE_PIXELMAP
    HILOG_DEBUG("[PurgeableResourceManager] Ability OnBackground ExecEndVisitPurgeableMem.");
    PurgeableMem::PurgeableResourceManager::GetInstance().ExecEndVisitPurgeableMem();
#endif
