    ...
    const AAFwk::LifeCycleStateInfo &targetState)
{
    ...
    if (ret) {
        HILOG_DEBUG("ExtensionImpl::HandleAbilityTransaction before AbilityManagerClient->AbilityTransitionDone");
        ...
        HILOG_DEBUG("ExtensionImpl::HandleAbilityTransaction after AbilityManagerClient->AbilityTransitionDone");
    }
...
void ExtensionImpl::Stop()
{
    ...
    HILOG_DEBUG("ExtensionImpl::Stop");
    extension_->OnStop();
    lifecycleState_ = AAFwk::ABILITY_STATE_INITIAL;
    HILOG_DEBUG("%{public}s end.", __func__);
}
...
sptr<IRemoteObject> ExtensionImpl::ConnectExtension(const Want &want)
{
    ...
    HILOG_DEBUG("ExtensionImpl:: ConnectAbility");
...
void ExtensionImpl::CommandExtension(const Want &want, bool restart, int startId)
{
    ...
    HILOG_DEBUG("ExtensionImpl:: CommandAbility");
