...
{
    HILOG_DEBUG("luc006,AbilityThread::SchedulePrepareTerminateAbility begin");
    if (abilityImpl_ == nullptr) {
        HILOG_ERROR("luc006,AbilityThread::SchedulePrepareTerminateAbility abilityImpl_ == nullptr");
        return -1;
    }

    int ret = abilityImpl_->PrepareTerminateAbility();
    HILOG_DEBUG("luc006,AbilityThread::SchedulePrepareTerminateAbility end, ret = %{public}d", ret);
    return ret;
}
