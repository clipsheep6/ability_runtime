...
constexpr static char AUTHENTICAT_EXTENSION[] = "AuthenticationExtensionAbility";
    ...
    std::shared_ptr<OHOSApplication> &application)
{
    ...
    if (abilityInfo->type == AbilityType::SERVICE) {
        ...
        if (abilityInfo->extensionAbilityType == ExtensionAbilityType::AUTHENTICAT) {
            abilityName = AUTHENTICAT_EXTENSION;
        }
