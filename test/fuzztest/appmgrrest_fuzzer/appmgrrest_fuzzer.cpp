...
bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
{
    ...
    std::shared_ptr<AppExecFwk::BundleMgrClient> bundleManager = nullptr;
    remoteClientManager.SetBundleManagerClient(bundleManager);
    ...
    remoteClientManager.GetBundleManagerClient();
