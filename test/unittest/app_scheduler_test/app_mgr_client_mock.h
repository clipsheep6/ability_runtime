...
public:
    ...
    MOCK_METHOD2(GetProcessRunningInfosByUserId, AppMgrResultCode(std::vector<RunningProcessInfo> &info, int32_t userId));
    ...
    // MOCK_METHOD3(GetApplicationInfoByProcessID, int(
    //     const int pid, AppExecFwk::ApplicationInfo &application, bool &debug));
