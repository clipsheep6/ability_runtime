 ...
 * FunctionPoints: AbilityManagerService ContinueMissionBundleName
 */
HWTEST_F(AbilityManagerServiceSecondTest, ContinueMissionBundleName_003, TestSize.Level1)
{
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceSecondTest ContinueMissionBundleName_003 start");
    auto abilityMs_ = std::make_shared<AbilityManagerService>();
    ...
    continueMissionInfo.wantParams = wantParams;
    EXPECT_EQ(abilityMs_->ContinueMission(continueMissionInfo, callback), CHECK_PERMISSION_FAILED);
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceSecondTest ContinueMissionBundleName_003 end");
}
