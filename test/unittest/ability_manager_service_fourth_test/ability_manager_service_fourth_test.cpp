 ...
 */
HWTEST_F(AbilityManagerServiceFourthTest, InitPushTask_001, TestSize.Level1)
{
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceFourthTest InitPushTask_001 start");
    auto abilityMs_ = std::make_shared<AbilityManagerService>();
    abilityMs_->InitPushTask();
    abilityMs_->Init();
    abilityMs_->InitPushTask();
    TAG_LOGI(AAFwkTag::TEST, "AbilityManagerServiceFourthTest InitPushTask_001 end");
}
