...
/**
 * @tc.name: AppMgrClient_GetCurrentAppIndex_001
 * @tc.desc: GetCurrentAppIndex.
 * @tc.type: FUNC
 */
HWTEST_F(AppMgrClientTest, AppMgrClient_GetCurrentAppIndex_001, TestSize.Level0)
{
    auto appMgrClient = std::make_unique<AppMgrClient>();
    EXPECT_NE(appMgrClient, nullptr);
    ...
    auto res = appMgrClient->GetCurrentAppIndex(appIndex_);
