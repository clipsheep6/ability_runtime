...
const std::string HELP_MSG = "usage: aa <command> <options>\n"
    ...
    "  attach                      attach bundle to enter debug mdoe\n"
    "  detach                      detach bundle to exit debug mode\n"
...
const std::string HELP_MSG_ATTACH_APP_DEBUG =
    ...
    "options list:\n"
    "  -h, --help                                             list available commands\n"
    "  -b <bundle-name>                                       let bundle enter debug mode\n";
const std::string HELP_MSG_DETACH_APP_DEBUG =
    "usage: aa detach <options>\n"
    "options list:\n"
    "  -h, --help                                             list available commands\n"
    "  -b <bundle-name>                                       let bundle exit debug mode\n";
...
const std::string STRING_ATTACH_APP_DEBUG_OK = "attach app successfully.";
const std::string STRING_ATTACH_APP_DEBUG_NG = "error: failed to attach app.";

const std::string STRING_DETACH_APP_DEBUG_OK = "detach app successfully.";
const std::string STRING_DETACH_APP_DEBUG_NG = "error: failed to detach app.";
